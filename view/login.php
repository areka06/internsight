    ...
    <main>
        ...
        <section class="login">
            ...
            <span><?php
                    ...
                    ?>
                <?php
                // Initialize the variable to avoid the undefined variable warning
                $username = "";
                $error = "";
                ...
                <?php endif; ?>
                <form class="form" action="../controllers/authenticate.php" method="post">
                    <!-- email -->
                    ...
                    <div class="inputForm">
                        ...
                        <input placeholder="Enter your Email" class="input" type="email" name="username" value="<?php echo $username ?>" required>
                    </div>
                    <!-- password -->
                    <div class="flex-column">
                    ...
                    <p class="p">Don't have an account? <a href="register.php"><span class="span">Sign Up</span></a>
...
<script>
    document.getElementById('myVideo').playbackRate = 0.8; // Set playback speed to 2x
</script>