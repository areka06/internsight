        ...
        <section class="login">
            ...
            <form class="form" action="/../controllers/registerperusahaan.php" method="post">
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Enter your Company Name" class="input" type="text" id="nama_perusahaan" name="nama_perusahaan" required>
                </div>
                ...
                <div class="inputForm">
                    ...
                    <input placeholder="Enter your Email" class="input" type="email" id="username" name="username" required>
                </div>
                ...
                <p class="p">Do you have an account? <a href="../login.php"><span class="span">Sign In</span></a>
